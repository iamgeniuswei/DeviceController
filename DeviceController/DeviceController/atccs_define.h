...
/**
 * -----------------------------------------------------------------------------
 * @brief 一般来说，应该使用枚举变量来枚举Gimbal的错误类型，但是Gimbal的错误值
 * 超过了windows xp 提供的枚举值的最大值，因此，使用常量来定义。
 * ENUM_AT_GIMBAL_ERRORS enumerates the Gimbal's errors.
 * -----------------------------------------------------------------------------
 */
