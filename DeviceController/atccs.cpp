...
namespace ATCCS
{
	...
	ATCCSInstructionResultReport::ATCCSInstructionResultReport(UINT32 plan, UINT16 at, UINT16 device, UINT32 sequence, UINT32 operation,UINT32 timeout, UINT32 result)
		:ATCCSReport()
	{
		memset(&_instruction, 0, sizeof(_AT_INSTRUCTION_RESULT));
	...
	void ATCCSInstructionResultReport::setInstructionResult(UINT32 plan, UINT16 at, UINT16 device, UINT32 sequence, UINT32 operation,UINT32 timeout, UINT32 result)
	{
		fillStruct(plan, at, device, sequence, operation,timeout, result);
	}
	...
	void ATCCSInstructionResultReport::fillStruct(UINT32 plan, UINT16 at, UINT16 device, UINT32 sequence, UINT32 operation,UINT32 timeout, UINT32 result)
	{
