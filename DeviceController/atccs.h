...
namespace ATCCS
{
	...
	*--------------------------------------------------------------*/
	...
	public:
		...
		ATCCSInstructionResultReport(UINT32 plan, UINT16 at, UINT16 device, UINT32 sequence, UINT32 operation, UINT32 timeout, UINT32 result);
		void setInstructionResult(UINT32 plan, UINT16 at, UINT16 device, UINT32 sequence, UINT32 operation,UINT32 timeout, UINT32 result);
		void setData();
		~ATCCSInstructionResultReport(void);
	private:
		void fillStruct(UINT32 plan, UINT16 at, UINT16 device, UINT32 sequence, UINT32 operation, UINT32 timeout, UINT32 result);
	private:
